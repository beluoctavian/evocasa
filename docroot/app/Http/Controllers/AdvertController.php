...
class AdvertController extends Controller {
  ...
  public static $improvements = [
    ...
    'termopan' => 'Termopan',
    'aer' => 'Aer conditionat',
    'instalatie_sanitara' => 'Instalatie sanitara noua',
    'instalatie_electrica' => 'Instalatie electrica noua',
    'contor_gaze' => 'Contor gaze individual',
    'centrala' => 'Centrala termica individuala',
    'mobilier' => 'Mobilier inclus',
  ...
  public static function getEntityDetails($id, $prepareForDisplay = FALSE)
  {
    ...
    $advert->setAttribute('price_history', json_decode($advert->price_history, TRUE));
