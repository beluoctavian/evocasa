...
<div class="row">
    <div class="col-xs-12">
        <div class="container-fluid">
            <form method="POST" action="{{ URL::to('adauga-anunt') }}">
                        ...
                        <div class="form-row">
                            <div class="form-group col-xs-12 col-sm-12">
                                <label class="checkbox-inline">
                                    <input name="first_page" type="checkbox" value="first_page"> Anuntul apare pe prima pagina
                                </label>
                            </div>
                            <div class="form-group col-xs-12 col-sm-12">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-xs-12">
                                        ...
                                        <div class="input-group">
                                            <input name="pret" type="text" class="form-control">
                                    ...
                                    <div class="form-group col-xs-12">
                                        ...
                                        <div class="input-group">
                                            <input name="pret_vechi" type="text" class="form-control">
                                            <span class="input-group-addon">&euro;</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xs-12 col-sm-8 no-padding">
                                <div class="form-row">
                                    <div class="form-group col-xs-12">
                                        ...
                                        <div>
                                            <textarea name="descriere" class="form-control" rows="4"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
